          ...
          <div className="row">
            ...
            <div className="service-item padd-15">
              <div className="service-item-inner">
                ...
                <p>Blockchain consulting, application development, infrastructure services,
                  security solutions, education and training, research and development,
                  and compliance and regulatory services, helping organizations leverage
                  blockchain technology for innovation, efficiency, and strategic advantage.</p>
              </div>
            </div>
            {/* Service Item 3 End */}
